...
void CodeGenFunction::EmitCfiSlowPathCheck(
    ...
    llvm::Value *Ptr, ArrayRef<llvm::Constant *> StaticArgs, bool fastXvcfi) {

  llvm::BasicBlock *Cont, *CheckBB;
  if (!fastXvcfi) {
    Cont = createBasicBlock("cfi.cont");
    CheckBB = createBasicBlock("cfi.slowpath");
